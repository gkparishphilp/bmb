class CreateGeoCountries < ActiveRecord::Migration
	def self.up
		...
		add_column	:geo_addresses, :geo_country_id, :integer
		add_column	:geo_states, :geo_country_id, :integer
		...
		execute 'update geo_states set geo_country_id = 1'
	...
	def self.down
		...
		remove_column	:geo_addresses, :geo_country_id
		remove_column	:geo_states, :geo_country_id
	end
end
